...
<div class="container-fluid places">
    ...
    <p class="text-center red bolded">In this application you can add new products</p>
    <h1 class="text-center">Nie wiem co tu napisać lub dodać do tego contentu index</h1>
